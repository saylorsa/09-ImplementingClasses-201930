...
class Point(object):
    ...
    def move_to(self,x,y):
        ...
        self.dist = self.dist + self.get_distance_from(Point(self.lastx,self.lasty))
    ...
    def get_distance_from_start(self):
        p1 = Point(self.startx,self.starty)
    ...
    def halfway_to(self,Point1):
        halfx = ((Point1.x - self.x)/2)+self.x
        halfy = ((Point1.y - self.y)/2)+self.y
